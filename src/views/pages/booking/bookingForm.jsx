          ...
          <div class="relative w-full rounded-3xl bg-amber-50 md:w-1/2">
            <div class="pb-12">
              <div class="flex w-full items-center justify-center rounded-full bg-yellow-300 p-2">
                <p class="ml-2 text-2xl font-bold text-indigo-900">Booking Form</p>
              </div>
              ...
              <div class="mt-8 pt-4 text-zinc-600">
                <div class="flex w-full px-4 md:px-28">
                  <div class="w-full rounded-xl border-2 border-gray-400 px-2 py-4">
                    ...
                    <div class="flex-col items-center justify-center px-4 py-4 md:flex md:flex-row md:space-x-9">
                      <div>
                        <p class="text-center md:text-left">Pick up off location</p>
                        <div class="flex w-full items-center justify-center">
                          <p class="relative ">Drop off location</p>
                          <div class="h-auto w-52 rounded-lg bg-gray-300">
                            <img src="https://img.icons8.com/ios-filled/50/228BE6/apple-phone.png" alt="apple-phone" />
                          </div>
                        </div>
                      </div>
                      <div>
                        <p class="text-center md:text-left">Drop off location</p>
                        <div class="flex w-full items-center justify-center">
                          <p class="relative ">Drop off location</p> 
                          <div class="h-auto w-52 rounded-lg bg-gray-300">
                            <img src="https://img.icons8.com/ios-filled/50/228BE6/apple-phone.png" alt="apple-phone" />
                ...
                <div class="flex w-full px-4 md:px-28">
                  <div class="w-full rounded-xl px-2 py-4">
                    <div>
                      <p class="py-2 text-sm font-medium">Plan your visit and book your services with ease</p>
                      <div class="w-full">
                        <input type="text"
                    ...
                    <div class="flex w-full space-x-4 py-10">
                      <div class="w-full space-y-4">
                        ...
                        <textarea name="" id="" cols="30" rows="10" placeholder="Description"
                          class="h-40 w-full rounded-lg border-2 border-gray-500 bg-slate-300 p-2 font-medium md:h-60"></textarea>
                      </div>
                      <div class="spa h-full w-full">
                        <div class="flex h-full w-full space-x-4 rounded-lg bg-gray-400 p-4">
                          ...
                          <div>
                            <div class="flex items-center justify-center">
                              <input class="peer/published h-6 w-6" type="radio" name="status" />
                            </div>
                            ...
                            <div class="mt-2">
                              ...
                              <div id="dropdown"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                  ...
                                  <li>
                                    <a href="#"
                                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Front</a>
                                  </li>
                                  <li>
                                    <a href="#"
                                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Middle</a>
                                  </li>
                                  <li>
                                    <a href="#"
                                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Back</a>
                                  </li>
                                  <li>
                                    <a href="#"
                                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Window</a>
                                  </li>
                                </ul>
                              </div>
                            </div>
                        ...
                        <div class="flex h-44 w-full items-center justify-center">
                          <button
                            class="relative mb-8 flex h-12 w-40 items-center justify-center overflow-hidden rounded-lg bg-gradient-to-r from-yellow-500 to-amber-200 text-sm font-medium text-black shadow-lg shadow-slate-500 hover:border-2 hover:border-zinc-400 hover:shadow-none">
                            <a href="bookingRequest.html">Confirm Booking</a>
                            <div
                              class="absolute right-0 mt-12 h-20 w-20 translate-x-1/2 transform rounded-full bg-yellow-200 bg-opacity-80">
                            </div>
                          </button>
                        </div>
                      </div>
        ...
        <div class="mx-auto flex flex-col justify-center space-y-4 p-4 md:flex-row md:space-x-20 md:space-y-0">
          <div class="relative -mt-24 rounded-lg bg-sky-900 text-white">
            ...
            <div class="m-4 pb-12">
              ...
              <div class="my-2 flex">
                <img width="48" height="48" src="https://img.icons8.com/color/48/circled-envelope.png"
              ...
              <div class="my-2 flex">
                <img width="48" height="48" src="https://img.icons8.com/ios-filled/50/228BE6/apple-phone.png"
                  alt="apple-phone" />
                <div class="ml-2">
          ...
          <div class="flex items-center justify-center">
            <div class="flex h-full items-center justify-center">
              <div class="relative w-48 rounded-lg bg-sky-800 p-4 text-white">
                <div class="items-left flex flex-col space-y-4 font-medium">
                  <p><a href="#" class="hover:border-b-2">About Us</a></p>
                  <p><a href="#" class="hover:border-b-2">Our Team</a></p>
                  <p><a href="#" class="hover:border-b-2">Our Project</a></p>
                  <p><a href="#" class="hover:border-b-2">Pricing</a></p>
                  <p><a href="#" class="hover:border-b-2">Contact</a></p>
                </div>
              </div>
            </div>
            ...
            <div class="flex h-full items-center justify-center">
              <div class="relative w-48 rounded-lg bg-sky-800 p-4 text-white">
                <div class="items-left flex flex-col space-y-4 font-medium">
                  <p><a href="#" class="hover:border-b-2">Style Guide</a></p>
                  <p><a href="#" class="hover:border-b-2">Changelog</a></p>
                  <p><a href="#" class="hover:border-b-2">License</a></p>
                  <p><a href="#" class="hover:border-b-2">Protected</a></p>
                  <p><a href="#" class="hover:border-b-2">Not Found</a></p>
                </div>
              </div>
            </div>
          </div>
