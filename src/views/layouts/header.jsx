...
const Header = () => {
  ...
  return (
    <>
          ...
          <div class="flex items-center justify-between font-semibold">
            ...
            <div class="flex md:hidden">
              <button
                id="hamburger"
                type="button"
                class="text-white hover:text-yellow-500 focus:text-yellow-500 focus:outline-none"
              >
                <svg
                  viewBox="0 0 24 24"
      ...
      <div
        class="fixed left-0 top-0 hidden h-full w-1/2 bg-black/50 md:hidden"
        id="responsiveMenu"
      >
        <div class="flex h-full items-center justify-center border-b border-white">
          <div class="flex w-full flex-col items-center font-semibold text-white">
            <a
              href="#"
              class="my-1 flex w-full justify-center rounded border py-2 hover:bg-yellow-500"
            >
              Home
            </a>
            <a
            ...
            <button
              id="closeMenu"
              class="ml-2 hidden text-white hover:bg-yellow-500 hover:text-black focus:outline-none"
            >
              <svg
                viewBox="0 0 24 24"
                class="h-6 w-6 fill-current"
